...
//printf("menu:%d \n");
        ...
        switch(menu){
            ...
            case ADSRL____: coders_for_menu("A",(const char*)nullptr,MAX_ADSR,0,ADSR,menuAdsrCoders,voicesSw,menuMaxAdsrCoders,adsrVar,ADSR_VAR_NB,BASIC_WAVES_NB,0);break;
