...
void coders_for_ampl();
void coders_for_freq();
...
gpio_put(TST_PIN,0);
        ...
        sprintf(buf,"voice:%d  amplifiers",currVoice);
...
void coders_for_freq()
{
        ...
        coderSetup(voicesFreqCoders,voicesSw,voicesMaxFreqCoders);
